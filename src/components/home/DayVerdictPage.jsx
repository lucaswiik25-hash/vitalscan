  ...
  return (
    ...
    >
      <div className="max-w-lg mx-auto px-5 pt-12 pb-24">
        ...
        {/* Score hero */}
        <motion.div {...fadeUp(0.06)} className="bg-white rounded-[24px] p-6 mb-4 glow-card">
        ...
        {meals.length === 0 ? (
          <motion.div {...fadeUp(0.1)} className="bg-white rounded-[24px] p-8 text-center glow-card">
            <p className="text-gray-400 text-sm">No meals were logged on this day.</p>
          </motion.div>
        ) : (
          <>
            {/* Calories */}
            <motion.div {...fadeUp(0.1)} className="bg-white rounded-[24px] p-5 mb-3 glow-card">
            ...
            {/* Macros */}
            <motion.div {...fadeUp(0.16)} className="bg-white rounded-[24px] p-5 mb-3 glow-card">
            ...
            {/* Water */}
            <motion.div {...fadeUp(0.22)} className="bg-white rounded-[24px] p-5 mb-3 glow-card">
            ...
            {/* Micro highlights */}
            <motion.div {...fadeUp(0.28)} className="bg-white rounded-[24px] p-5 mb-3 glow-card">
            ...
            {/* Meals list */}
            <motion.div {...fadeUp(0.42)} className="bg-white rounded-[24px] p-5 glow-card">
