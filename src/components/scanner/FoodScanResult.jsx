...
Re-analyze the ENTIRE meal based on the correction. If user says an ingredient is NOT present (e.g. "no blueberries"), remove it from ingredients_text and recalculate ALL macros, vitamins, and health analysis accordingly. Update name only if needed. Return complete updated analysis.`,
  ...
  const slide0 = (
    <div className="pb-4 space-y-3 fade-in-up">
      <div className="bg-white rounded-[22px] p-5" style={{ boxShadow: '0 2px 16px rgba(0, 0, 0, 0.13)', border: '1px solid rgba(0,0,0,0.08)' }}>
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          ...
          <div key={label} className="bg-white rounded-[18px] p-3 flex flex-col gap-2" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
      ...
      {result.diet_reason || result.appearance_reason ? (
        <div className="bg-white rounded-[18px] p-4" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
  ...
  const slide1 = (
    <div className="pb-4 space-y-3 fade-in-up">
      ...
      <div className="bg-white rounded-[22px] p-4 space-y-2" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
  ...
  const slideVitamins = (
    <div className="pb-4 space-y-3 fade-in-up">
      <div className="bg-white rounded-[22px] p-4" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
  ...
  const slide2 = result.is_appearance_mode ? (
    <div className="pb-4 space-y-4 fade-in-up">
      ...
      <div className="bg-white rounded-[22px] overflow-hidden" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
        {[
  ...
  const slide3 = result.is_appearance_mode ? (
    <div className="pb-4 space-y-3 fade-in-up">
      ...
      {result.processing_level && (
        <div className="flex items-center justify-between bg-white rounded-[18px] px-4 py-3" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
      ...
      {parsedIngredients.length > 0 && !ingredientResult && (
        <div className="space-y-1.5 mb-3">
          {parsedIngredients.map((name, i) => (
            <div key={i} className="bg-white rounded-[14px] px-4 py-2.5" style={{ boxShadow: '0 1px 6px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
      ...
      {ingredientResult && (
        <div className="space-y-2">
          ...
          {(ingredientResult.ingredients || []).map((ing, i) => {
            ...
            return (
              <div key={i} className="bg-white rounded-[18px] p-3" style={{ boxShadow: '0 1px 6px rgba(0,0,0,0.06)', border: '1px solid rgba(0, 0, 0, 0.13)' }}>
