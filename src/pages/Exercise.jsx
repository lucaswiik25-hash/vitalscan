...
export default function Exercise() {
  ...
  return (
    <div className="min-h-screen pb-32 flex flex-col" style={{ background: 'transparent' }}>
      ...
      <div className="flex-1 px-4 pt-5">
        <h3 className="text-xl font-bold text-white mb-4 ml-2">Quick Add</h3>

        <div className="flex flex-col items-center gap-3">
          {QUICK_EXERCISES.map((ex, i) => {
            // Each successive item is smaller, more faded, and narrower
