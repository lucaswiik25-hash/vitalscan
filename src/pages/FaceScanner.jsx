  ...
  return (
    <div className="min-h-screen px-6 pt-14 pb-20">
      ...
      <div className="space-y-6">
        <p className="text-3xl font-bold text-gray-900 leading-snug">Face Scanner</p>
        <p className="text-2xl font-semibold text-gray-900 leading-relaxed">
          <button onClick={() => cameraRef.current?.click()} className="inline-flex items-center px-4 py-1.5 rounded-full bg-gray-900 text-white text-lg font-bold active:scale-95 transition-transform mx-1" style={{ verticalAlign: 'middle' }}>Take Selfie</button>{' '}
          for AI skin & facial analysis.
        </p>
        <p className="text-2xl font-semibold text-gray-900 leading-relaxed">
          Or{' '}
