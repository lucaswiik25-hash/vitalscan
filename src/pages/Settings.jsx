  ...
  return (
    <div className="min-h-screen bg-background pb-10">
      ...
      <div className="px-5 space-y-4">
        {/* Profile summary */}
        <div className="bg-white border border-border rounded-[24px] p-5 shadow-sm flex items-center gap-4">
        ...
        {/* Diet & Goals */}
        <div className="bg-white border border-border rounded-[24px] px-5 shadow-sm">
